	...
	<div id="content">
		...
		<div id="breadcrumb">
			<a href="main.jsp" class="tip-bottom"> <i class="icon-home"></i>
				首页
			</a> <a href="#" class="current">查看个人信息</a>
		</div>
					...
					<div class="widget-box">
						...
						<table width="100%">
							...
							<tr>
								...
								<td align="left">&nbsp;&nbsp; 研发一部</td>
								<td></td>
							</tr>
							<tr>
								<td align="right">职位:</td>
								<td align="left">&nbsp;&nbsp; 高级软件工程师(4级)</td>
								<td></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left">&nbsp;&nbsp; 2015年7月5日</td>
								<td></td>
							</tr>
							<tr>
								<td align="right">生日:</td>
								<td align="left">&nbsp;&nbsp; 1990年2月14日</td>
								<td></td>
								<td></td>
							</tr>
							<tr>

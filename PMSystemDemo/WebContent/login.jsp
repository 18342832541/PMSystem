...
<body>
${param.LoginMsg == "noUser"?"<script>alert('用户名不存在!')</script>":"" }
${param.LoginMsg == "passwordError"?"<script>alert('密码输入错误!')</script>":"" }
${ param.etips == "etips"?"<script>alert('你不登录，不让你访问内部！请你先登录，谢谢！')</script>":"" }
	<div id="logo" style="text-align: center; color: #fff;">

		<h3>人事管理系统网站</h3>
	</div>
	<div id="loginbox">
		<form id="loginform" class="form-vertical" action="${pageContext.request.contextPath }/UserLoginServlet">
			<p>请在输入用户名和密码进行登录</p>
			...
			<div class="control-group">
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on" title="密码"><i class="icon-lock"></i></span> <input
		...
		<form id="recoverform" action="#" class="form-vertical">
			...
			<div class="form-actions">
				<span class="pull-left"><a href="#" class="flip-link"
					...
					type="submit" class="btn btn-inverse" value="重置密码" /></span>
			</div>
		</form>
	</div>
